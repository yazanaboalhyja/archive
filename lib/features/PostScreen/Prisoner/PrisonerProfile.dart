...
class webPrisonerProfile extends StatefulWidget {



  @override
  State<webPrisonerProfile> createState() => _MartyrsProfileState();
}

class _MartyrsProfileState extends State<webPrisonerProfile> {
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image: NetworkImage("http://127.0.0.1:3000/uploads/${provider.selectedPrisoner.photo_url!}"),
                            ),
