...
class _VideoPlayerScreenState extends State<VideoPlayerScreen1> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.network(
      'http://10.0.2.2:3000/uploads/'+ Provider.of<AppProvider>(context,listen: false).selectedVideo.video_path
              ...
              Row(
                ...
                children: [
                  SizedBox(
                    ...
                    child:
                    Text('موقع الفيديو :'+Provider.of<AppProvider>(context).selectedVideo.location,
                      // maxLines: 2,
                      style: TextStyle(
