...
// Route to add a new martyr with photo
router.post('/add_prisoners', verifyToken, upload.single('photo'), (req, res) => {
  ...
  const INSERT_MARTYRS_QUERY = `INSERT INTO review_prisoners (name, date_of_birth, date_of_arrest, place_of_birth, life_story, photo_url, submitted_by) VALUES (?, ?, ?, ?, ?, ?, ?)`;
